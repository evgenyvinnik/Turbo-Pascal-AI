...
export const isSeparator = (n: MenuNode): n is MenuSeparator => (n as MenuSeparator).separator;
...
export const MENUS: MenuDef[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: '~S~ave',
        shortcut: 'F2',
        hint: 'Save the file in the active Edit window',
      },
      ...
      SEP,
      {
        id: 'file.chdir',
        label: '~C~hange dir...',
        hint: 'Change the current drive and directory',
      },
      { id: 'file.print', label: '~P~rint', hint: 'Print the contents of the active window' },
      {
        id: 'file.printer',
        label: 'P~r~inter setup...',
        hint: 'Set up your printer filter program',
      },
    ...
    items: [
      {
        ...
        label: '~U~ndo',
        shortcut: 'Alt+BkSp',
        hint: 'Undo the previous editor operation',
      },
      ...
      SEP,
      {
        ...
        label: 'Cu~t~',
        shortcut: 'Shift+Del',
        hint: 'Remove the selected text and put it in the clipboard',
      },
      {
        id: 'edit.copy',
        label: '~C~opy',
      ...
      },
      {
        ...
        label: '~P~aste',
        shortcut: 'Shift+Ins',
        hint: 'Insert the clipboard contents at the cursor',
      },
      {
        id: 'edit.clear',
        label: 'C~l~ear',
        shortcut: 'Ctrl+Del',
        hint: 'Delete the selected text without copying it',
      },
      SEP,
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'search.goto',
        label: '~G~o to line number...',
        hint: 'Move cursor to specified line number in file',
      },
      {
        id: 'search.lasterror',
        label: 'Show last compiler error',
        hint: 'Show the position of the last compiler error',
        disabled: true,
      },
      {
        id: 'search.finderror',
        label: 'Find ~e~rror...',
        hint: 'Find the source position of a runtime error',
      },
      {
        id: 'search.findproc',
        label: 'Find ~p~rocedure...',
        hint: 'Find a procedure while debugging',
      },
    ],
  },
  {
    ...
    items: [
      { id: 'run.run', label: '~R~un', shortcut: 'Ctrl+F9', hint: 'Run the current program' },
      {
        ...
        label: '~S~tep over',
        shortcut: 'F8',
        hint: 'Execute the next source line, skipping calls',
      },
      {
        id: 'run.trace',
        label: '~T~race into',
        shortcut: 'F7',
        hint: 'Execute the next source line, entering calls',
      },
      {
        id: 'run.gotocursor',
        label: '~G~o to cursor',
        shortcut: 'F4',
        hint: 'Run the program up to the cursor position',
      },
      {
        id: 'run.reset',
        label: '~P~rogram reset',
        shortcut: 'Ctrl+F2',
        hint: 'Stop the debugging session',
        disabled: true,
      },
      {
        id: 'run.params',
        label: 'P~a~rameters...',
        hint: 'Set the command line parameters of the program',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        label: '~C~ompile',
        shortcut: 'Alt+F9',
        hint: 'Compile source file',
      },
      {
        id: 'compile.make',
        label: '~M~ake',
        shortcut: 'F9',
        hint: 'Rebuild the parts of the program that changed',
      },
      { id: 'compile.build', label: '~B~uild', hint: 'Rebuild all the parts of the program' },
      SEP,
      {
        id: 'compile.destination',
        label: '~D~estination',
        shortcut: 'Memory',
        hint: 'Toggle the compiler destination between Memory and Disk',
      },
      {
        id: 'compile.primary',
        label: '~P~rimary file...',
        hint: 'Set the file that Make and Build compile',
      },
      {
        id: 'compile.clearprimary',
        label: 'C~l~ear primary file',
        hint: 'Clear the primary file setting',
      },
      SEP,
      {
        id: 'compile.info',
        label: '~I~nformation...',
        hint: 'Display information about the current program',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        label: '~B~reakpoints',
        hint: 'Set conditional breakpoints, view and edit breakpoints',
      },
      {
        id: 'debug.callstack',
        label: '~C~all stack',
        shortcut: 'Ctrl+F3',
        hint: 'Display the sequence of active procedure calls',
      },
      ...
      { id: 'debug.output', label: '~O~utput', hint: 'Open the program output window' },
      {
        ...
        label: '~U~ser screen',
        shortcut: 'Alt+F5',
        hint: 'Display the full program output screen',
      },
      SEP,
      {
        id: 'debug.evaluate',
        ...
        shortcut: 'Ctrl+F4',
        hint: 'Evaluate an expression or change a variable',
      },
      {
        id: 'debug.addwatch',
        label: '~A~dd watch...',
        shortcut: 'Ctrl+F7',
        hint: 'Enter expression to add as watch',
      },
      {
        id: 'debug.addbreak',
        label: 'Add break~p~oint...',
        hint: 'Add a breakpoint at the cursor position',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        shortcut: 'Alt+F7',
        hint: 'Go to the previous message',
        disabled: true,
      },
      SEP,
      {
        ...
        label: '~G~rep',
        shortcut: 'Shift+F2',
        hint: 'Search files for a text pattern',
      },
      {
        id: 'tools.tasm',
        label: 'Turbo ~A~ssembler',
        shortcut: 'Shift+F3',
        hint: 'Run Turbo Assembler',
      },
      {
        id: 'tools.tdebug',
        label: 'Turbo ~D~ebugger',
        shortcut: 'Shift+F4',
        hint: 'Run Turbo Debugger',
      },
      {
        id: 'tools.tprof',
        label: 'Turbo P~r~ofiler',
        shortcut: 'Shift+F5',
        hint: 'Run Turbo Profiler',
      },
    ],
  },
  {
    ...
    items: [
      {
        id: 'options.compiler',
        label: '~C~ompiler...',
        hint: 'Set default compiler directives and conditional defines',
      },
      {
        id: 'options.memory',
        label: '~M~emory sizes...',
        hint: 'Set the stack size and the heap limits',
      },
      {
        id: 'options.linker',
        label: '~L~inker...',
        hint: 'Set the link buffer and map file options',
      },
      {
        id: 'options.debugger',
        label: 'De~b~ugger...',
        hint: 'Set the integrated debugging options',
      },
      {
        id: 'options.directories',
        label: '~D~irectories...',
        hint: 'Set the directories the compiler searches',
      },
      {
        id: 'options.tools',
        label: '~T~ools...',
        hint: 'Add, edit and delete entries in the Tools menu',
      },
      SEP,
      {
      ...
      { id: 'options.save', label: '~S~ave', hint: 'Save the current options' },
      {
        id: 'options.saveas',
        label: 'Save ~a~s...',
        hint: 'Save the current options under a new name',
      },
    ],
  },
  {
    ...
    items: [
      ...
      SEP,
      {
        ...
        label: '~S~ize/Move',
        shortcut: 'Ctrl+F5',
        hint: 'Change the size or position of the active window',
      },
      {
        id: 'window.zoom',
        label: '~Z~oom',
        shortcut: 'F5',
        hint: 'Enlarge or restore the active window',
      },
      { id: 'window.next', label: '~N~ext', shortcut: 'F6', hint: 'Make the next window active' },
      {
        ...
        label: '~P~revious',
        shortcut: 'Shift+F6',
        hint: 'Make the previous window active',
      },
      ...
      SEP,
      {
        ...
        label: '~L~ist...',
        shortcut: 'Alt+0',
        hint: 'Display a list of all open windows',
      },
    ],
  },
  {
    ...
    items: [
      { id: 'help.contents', label: '~C~ontents', hint: 'Show table of contents for online Help' },
      {
        ...
        label: '~I~ndex',
        shortcut: 'Shift+F1',
        hint: 'Show the index of Help topics',
      },
      {
        id: 'help.topic',
        label: '~T~opic search',
        shortcut: 'Ctrl+F1',
        hint: 'Show Help for the word at the cursor',
      },
      {
        id: 'help.previous',
        label: '~P~revious topic',
        shortcut: 'Alt+F1',
        hint: 'Show the previous Help topic',
      },
      ...
      {
        id: 'help.directives',
        label: 'Compiler ~d~irectives',
        hint: 'Show Help on compiler directives',
      },
      {
        id: 'help.procedures',
        label: 'Pr~o~cedures and functions',
        hint: 'Show Help on the standard procedures and functions',
      },
      ...
      {
        id: 'help.language',
        label: 'Turbo Pascal ~L~anguage',
        hint: 'Show Help on the Turbo Pascal language',
      },
      {
        id: 'help.errors',
        label: '~E~rror messages',
        hint: 'Show Help on the compiler and runtime errors',
      },
      SEP,
