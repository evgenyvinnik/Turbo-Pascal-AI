...
export const DOS_EXAMPLES: DosFiles = {
  'HELLO.COM': bytesToString(new Uint8Array([
    0xba, 0x0c, 0x01, // mov dx,010c
    0xb4, 0x09, // mov ah,09
    0xcd, 0x21, // int 21 (DOS writes the $-terminated string)
  ...
  'X86TEST.SCR': [
    'n REGTEST.COM', 'a 100', 'mov ax,1234', 'mov bx,0002', 'add ax,bx',
    'push ax', 'pop dx', 'mov ax,4c00', 'int 21', '',
    'r cx', 'f', 'w', 'u 100 10e', 't 5', 'r', 'q', '',
  ].join('\r\n'),
};
